  ...
  <div class="logementModal">
      <div class="logement-content">
            ...
            <div class="logement-detail">
                ...
                <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="py-6 px-6 lg:px-8 modals">
                                ...
                                <div class="facturation">
                                    ...
                                    <p>- Prix du voiture <strong>{{defaultPrice}}</strong> / jour </p>
...
export default {
  ...
  methods: {
    ...
    submitReservation(){
      ...
      this.$store.commit('setNbr_persCar' , this.nbr_pers);
      ...
      this.$store.commit('setCarToPay' , toPay)
      this.price = toPay

      
    } ,
    async sendReservation(){
      const nbr_pers = this.$store.state.nbr_persCar;
      const idCar = this.$store.state.idCar;     
      const date_enter = this.startDisplay;
      const date_leave = this.endDisplay;
      const toPay = this.$store.state.toCarPay;

      await axios.post(process.env.VUE_APP_URL+'/car/reservation/' , {
          car : idCar ,
          nbr_pers,
          date_enter,
          date_leave,
