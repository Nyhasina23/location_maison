<template>
  <div class="logementModal">
    <div class="logement-content">
      ...
      <div class="logement-detail">
        ...
        <div class="mb-6">
          <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            {{ $t('nbr_pers') }} </label>
          <input type="number" v-model="nbr_pers" id="base-input"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="mb-6">
          <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            {{ $t('entry_date') }} </label>
          <input type="text" v-model="startDisplay" disabled id="base-input"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="mb-6">
          <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            {{ $t('release_date') }} </label>
          <input type="text" v-model="endDisplay" disabled id="base-input"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
                ...
                <form class="space-y-6" action="#">
                  <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                      {{ $t('ref') }}</label>
                    <input v-model="reference" type="text" name="email" id="email"
                  ...
                  <p class="text-sm methode">Mvola : +261385270349</p>
        ...
        <button
          ...
          data-modal-toggle="authentication-modal" @click="submitReservation">{{ $t('reserve') }}</button>
      </div>

      <div v-if="success" id="popup-modal" tabindex="-1"
        class="modals overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
      ...
      <div v-if="error" id="popup-modal" tabindex="-1"
        class="modals overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
            ...
            <div class="p-6 text-center check-modal">
              ...
              <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Votre réservation n'a pas été
                envoyée , veuillez réessayer</h3>
              <div class="flex">
                <a href="/" data-modal-toggle="popup-modal" type="button"
                  class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                  Annuler
                </a>
                <button @click="disableError" type="button"
