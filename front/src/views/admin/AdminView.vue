  ...
  <div class="admin">
      ...
      <div class="right">
          ...
          <div v-if="showAddLog" class="edit-profile relative w-full overflow-x-auto  sm:rounded-lg">
            ...
            <button v-if="!isWaitAddLogement" @click="addLogement" type="button" class=" w-fitC ml-8 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
                Valider
            </button>
