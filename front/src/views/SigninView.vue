        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="py-6 px-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Se connecter </h3>
                    <form class="space-y-6" action="#">
                        ...
                        <button type="button" @click="login" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Connexion</button>
                        ...
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                            Vous n'avez pas de compte? <a href="/signup" class="text-blue-700 hover:underline dark:text-blue-500">S'inscrire</a>
                        </div>
                    </form>
                </div>
            </div>
